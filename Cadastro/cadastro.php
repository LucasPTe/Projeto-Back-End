    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area" id="box-area">
            ...
            <div class="input-group mb-3">
                    <a href="/Tela inicial/index.html"><input type="button" value="Tenho Login" class="btn btn-primary botao_card"></a>
            </div>
            
            <p style="font-size: 25px;" class="d-flex justify-content-center cadastro_titulo" id="cadastro_titulo">CADASTRE-SE</p>
            ...
            <div class="col-md-6 right-box" id="right-box">
                <div class="row align-items-center">
                    ...
                    <label for="e-mail" id="labelEmail">E-mail</label>
                    <div class="input-group mb-3">
                        <input type="email" class="form-control form-control-lg bg-light fs-6" required id="E-mail" placeholder="">
                    </div>
                    ...
                    <label for="nome_da_mae" id="labelMae">Nome Materno</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-lg bg-light fs-6" id="mae" required placeholder="">
                    </div>
                    ...
                    <label for="numero_de_celular" id="labelCelular">Telefone Celular</label>
                    <div class="input-group mb-3">
                        <input type="tel" class="form-control form-control-lg bg-light fs-6" required id="celular" placeholder="(+55) XX XXXXX-XXXX">
                    </div>
                </div>

                <div class="botao">
                    <button type="button" class="btn btn-primary btn-lg">Cadastrar Dados</button>
                    <button type="button" class="btn btn-secondary btn-lg">Limpar Dados</button>    
                </div>
            ...
            <div class="col-md-6 right-box" id="right-box">
                <div class="row align-items-center">
                    ...
                    <div class="input-group mb-3">
                        <input type="tel" class="form-control form-control-lg bg-light fs-6" required id="fixo" placeholder="(+55) XX XXXX-XXXX">
                    </div>
                    <label for="endereco" id="labelRua">Endereço</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-lg bg-light fs-6" required id="endereco" placeholder="">
                    </div>
                    <label for="endereco" id="labelBairro">Bairro</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-lg bg-light fs-6" required id="endereco" placeholder="">
                    </div>
                    <label for="endereco" id="labelNumero">Número</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-lg bg-light fs-6" required id="endereco" placeholder="">
                    </div>
                    <label for="endereco" id="labelCEP">CEP</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-lg bg-light fs-6" required id="endereco" placeholder="">
                    </div>
